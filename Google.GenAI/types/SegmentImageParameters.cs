...
namespace Google.GenAI.Types {
  ...
  internal record SegmentImageParameters {
    /// <summary>
    ...
    /// <returns>The deserialized SegmentImageParameters object, or null if deserialization
    /// fails.</returns>
    public static SegmentImageParameters
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<SegmentImageParameters>(jsonString, options);
